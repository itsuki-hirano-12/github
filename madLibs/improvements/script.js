(function(){
    ...
    function showErrors(formData, emptyFields) {
        ...
        switch(errorId) {
            case 'animal1':
            case 'animal2': errorName = 'a name of an animal';
                break;
            case 'food': errorName = 'a type of food';
                break;
            case 'length': errorName = 'a length';
                break;
            case 'adverb': errorName = 'an adverb';
                break;
            case 'adjective1':
            case 'adjective2': errorName = 'an adjective';
                break;
            default: errorName = 'a number with its suffix';
        }
        
        inputHeader.innerHTML = `Please give me ${errorName}!`;
