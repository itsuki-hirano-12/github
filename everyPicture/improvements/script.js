    ...
    window.addEventListener('load', function() {
        ...
        setTimeout( function(){
            ...
            setTimeout( function(){
                ...
                initialText.className = 'textInitialState';
            }, 700);    
        }, 1500);
    });
        ...
        if (prevCard === 'initial') {
            ...
            switch(number) {
                ...
                case 5:
                    ...
                    break;
                case 6: 
                    playArea.style.backgroundColor = 'rgba(255, 127, 80, 0.227)'
                    playArea.style.borderColor = 'coral';
                    break;
                case 7:
                case 8:
                    playArea.style.backgroundColor = 'rgba(128, 128, 0, 0.289)'
                    playArea.style.borderColor = 'olive';
                    break;
                default:
                    playArea.style.backgroundColor = 'rgba(25, 25, 112, 0.2)'
                    playArea.style.borderColor = 'midnightblue';
